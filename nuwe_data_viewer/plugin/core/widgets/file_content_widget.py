...
from nuwe_data_viewer.plugin.core.widgets.UI_file_content_widget import Ui_FileContentWidget
...
from nuwe_data_viewer.plugin.core.model.message_content_model import MessageContentModel
